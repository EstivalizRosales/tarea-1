...
Lo primero que haremos es cargar los datos a Rstudio para comenzar el
analisis, y utilizaremos “summary” para obtener un ejemplo de lo que
estaremos visualizando.
...
Para poder hacer el analisis necesario, no decesitamos de todos los
datos, es por eso que procederemos a eliminar columnas de datos que no
utilizaremos.
...
```
    ...
    ##    <chr>                           <chr>        <chr>            <chr>          
    ##  1 Palestino vs Deportivo Antofag~ 204          252              80.95238095238~
    ##  2 Colo Colo vs Palestino          184          230              80             
    ##  3 Palestino vs O'Higgins          162          203              79.80295566502~
    ##  4 Audax Italiano vs Palestino     151          197              76.64974619289~
    ##  5 Palestino vs Huachipato         132          181              72.92817679558~
    ##  6 Uni<f3>n Espa<f1>ola vs Palest~ 107          149              71.81208053691~
    ##  7 Santiago Wanderers vs Palestino 110          173              63.58381502890~
    ##  8 Promedio Pases                  150          197.857142857143 75.10416502452~
    ##  9 Max Pases                       204          252              80.95238095238~
    ## 10 Min Pases                       107          149              63.58381502890~
...
![](tarea-2_ayudantia_files/figure-gfm/unnamed-chunk-6-5.png)<!-- -->
